...
const actions = {
	// Action creator
	setActiveCouponsOption( active_coupons_option)
	{
		return {
			type: 'SET_ACTIVE_COUPONS_OPTION',
			active_coupons_option,
		}
	},
	...
	'woocommerce-coupon-shortcodes/coupon-is-active',
	{
		...
		(
			props => {
				...
				const handleActiveCouponsOption = ( active_coupons ) => setAttributes(
						...
						<PanelBody title={ __( 'Block Attributes', 'woocommerce-coupon-shortcodes' ) } className="block-inspector">
							<PanelRow>
								<label htmlFor="block-woo-coupon-codes-all" className="woo-coupon-codes-inspector__label">
									{ __( 'Content will be shown for the selected coupons', 'woocommerce-coupon-shortcodes' ) }
								</label>
							</PanelRow>
							<PanelRow>
								<ToggleControl
