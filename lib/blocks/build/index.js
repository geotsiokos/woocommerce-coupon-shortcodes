...
/***/ "./src/blocks/coupon-code/block.js":
/*!*****************************************!*\
  !*** ./src/blocks/coupon-code/block.js ***!
  \*****************************************/
/*! no exports provided */
...
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./editor.css */ "./src/blocks/coupon-code/editor.css");
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_editor_css__WEBPACK_IMPORTED_MODULE_11__);
...
var actions = {
  // Action creator
  setCouponCodes: function setCouponCodes(coupon_codes) {
    return {
      type: 'SET_COUPON_CODES',
      coupon_codes: coupon_codes
    };
  },
  setCodeSeparator: function setCodeSeparator(code_separator) {
    return {
      type: 'SET_CODE_SEPARATOR',
      code_separator: code_separator
    };
  },
  getCouponCodes: function getCouponCodes(path) {
    return {
      type: 'GET_COUPON_CODES',
      path: path
    };
  },
  getCodeSeparator: function getCodeSeparator(path) {
    return {
...
var store = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["createReduxStore"])('woocommerce-coupon-shortcodes/woocommerce-coupon-shortcodes-blocks', {
  ...
  actions: actions,
  selectors: {
    getCouponCodes: function getCouponCodes(state) {
      var coupon_codes = state.coupon_codes;
      return coupon_codes;
    },
    getCodeSeparator: function getCodeSeparator(state) {
      var code_separator = state.code_separator;
  ...
  resolvers: {
    getCouponCodes: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function getCouponCodes(state) {
      var path, coupon_codes;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function getCouponCodes$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              path = '/woocommerce-coupon-shortcodes/blocks/woocommerce-coupon-shortcodes/';
              _context.next = 3;
              return actions.fetchFromAPI(path);

            case 3:
              coupon_codes = _context.sent;
              return _context.abrupt("return", actions.setCouponCodes(coupon_codes));
...
Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["register"])(store);
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["registerBlockType"])('woocommerce-coupon-shortcodes/coupon-code', {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Coupon Code', 'woocommerce-coupon-shortcodes'),
  // Block title.
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Show the code for selected coupon(s).', 'woocommerce-coupon-shortcodes'),
  icon: 'smiley',
  // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
  category: 'woocommerce-coupon-shortcodes',
  // Block category
  ...
  edit: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["withSelect"])(function (select) {
    return {
    ...
    var coupon_codes_select = props.attributes.coupon_codes_select,
        code_separator = props.attributes.code_separator,
        codes = props.codes,
        className = props.className,
        setAttributes = props.setAttributes,
        isSelected = props.isSelected;

    var handleCouponsCodesChange = function handleCouponsCodesChange(coupon_codes_select) {
      return setAttributes({
        coupon_codes_select: JSON.stringify(coupon_codes_select)
      });
    };

    var handleCodeSeparatorChange = function handleCodeSeparatorChange(code_separator) {
      return setAttributes({
    ...
    var insertedCodeSeparator = [];

    if (null !== code_separator) {
      insertedCodeSeparator = JSON.parse(code_separator);
    }

    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Block Attributes', 'woocommerce-coupon-shortcodes'),
      className: "block-inspector"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("label", {
      htmlFor: "block-woo-coupon-codes-all",
      className: "woo-coupon-codes-inspector__label"
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Code will be shown for the selected coupons', 'woocommerce-coupon-shortcodes'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      isClearable: true,
      isMulti: "true"
    })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["TextControl"], {
      ...
      className: isSelected ? classnames__WEBPACK_IMPORTED_MODULE_4___default()(className) + '__selected' : props.className
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      className: classnames__WEBPACK_IMPORTED_MODULE_4___default()(className) + '__inner-block'
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InnerBlocks"], null)))];
  }),
  save: function save(props) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InnerBlocks"].Content, null));
  }
});

/***/ }),

/***/ "./src/blocks/coupon-code/editor.css":
/*!*******************************************!*\
  !*** ./src/blocks/coupon-code/editor.css ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/blocks/coupon-is-active/block.js":
/*!**********************************************!*\
  !*** ./src/blocks/coupon-is-active/block.js ***!
  \**********************************************/
/*! no exports provided */
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./editor.css */ "./src/blocks/coupon-is-active/editor.css");
/* harmony import */ var _editor_css__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_editor_css__WEBPACK_IMPORTED_MODULE_11__);
...
var DEFAULT_STATE = {
  active_coupons_option: false,
  coupon_codes: {},
  coupon_codes_operator: 'and'
};
var actions = {
  // Action creator
  setActiveCouponsOption: function setActiveCouponsOption(active_coupons_option) {
    return {
      type: 'SET_ACTIVE_COUPONS_OPTION',
      active_coupons_option: active_coupons_option
    };
  },
  setCouponCodes: function setCouponCodes(coupon_codes) {
    return {
  ...
  setCouponCodesOperator: function setCouponCodesOperator(coupon_codes_operator) {
    return {
      type: 'SET_COUPON_CODES_OPERATOR',
      coupon_codes_operator: coupon_codes_operator
    };
  },
  getCouponCodes: function getCouponCodes(path) {
    return {
...
var store = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["createReduxStore"])('woocommerce-coupon-shortcodes/woocommerce-coupon-shortcodes-blocks', {
  reducer: function reducer() {
    ...
    switch (action.type) {
      case 'SET_ACTIVE_COUPONS_OPTION':
        return _objectSpread(_objectSpread({}, state), {}, {
          active_coupons_option: action.active_coupons_option
        });
  ...
  actions: actions,
  selectors: {
    getActiveCouponsOption: function getActiveCouponsOption(state) {
      var active_coupons_option = state.active_coupons_option;
      return active_coupon_options;
    },
    getCouponCodes: function getCouponCodes(state) {
      var coupon_codes = state.coupon_codes;
      return coupon_codes;
    },
    getCouponCodesOperator: function getCouponCodesOperator(state) {
      var coupon_codes_operator = state.coupon_codes_operator;
...
Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["register"])(store);
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["registerBlockType"])('woocommerce-coupon-shortcodes/coupon-is-active', {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Coupon is Active', 'woocommerce-coupon-shortcodes'),
  // Block title.
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Show content for active coupon(s). A coupon is considered active while it has not expired and its usage limits have not been exhausted.', 'woocommerce-coupon-shortcodes'),
  icon: 'smiley',
  // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
  category: 'woocommerce-coupon-shortcodes',
  // Block category
  ...
  edit: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["withSelect"])(function (select) {
    return {
      // the store name to be used with the selector
      codes: select('woocommerce-coupon-shortcodes/woocommerce-coupon-shortcodes-blocks').getCouponCodes() //codes_operator: select('woocommerce-coupon-shortcodes/woocommerce-coupon-shortcodes-blocks' ).getCouponCodesOperator(),

    };
  })(function (props) {
    var active_coupons = props.attributes.active_coupons,
        coupon_codes_select = props.attributes.coupon_codes_select,
        operator_select = props.attributes.operator_select,
        codes = props.codes,
        codes_operator = props.codes_operator,
        className = props.className,
        setAttributes = props.setAttributes,
        isSelected = props.isSelected;
    ...
    var handleActiveCouponsOption = function handleActiveCouponsOption(active_coupons) {
      return setAttributes({
        active_coupons: JSON.stringify(active_coupons)
      });
    };
    ...
    var handleOperatorChange = function handleOperatorChange(operator_select) {
      return setAttributes({
        operator_select: JSON.stringify(operator_select)
      });
    };

    var activeCoupons = false;
    ...
    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      ...
      htmlFor: "block-woo-coupon-codes-all",
      className: "woo-coupon-codes-inspector__label"
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Content will be shown for the selected coupons', 'woocommerce-coupon-shortcodes'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["ToggleControl"] //label="All active coupons"
    , {
      help: activeCoupons ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('All active coupons', 'woocommerce-coupon-shortcodes') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Coupons selected from the list.', 'woocommerce-coupon-shortcodes'),
      checked: activeCoupons,
      onChange: handleActiveCouponsOption
    })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_5__["default"], {
      className: "woo-coupon-codes-inspector__control",
      name: "block-woo-coupon-codes",
      value: selectedCouponCodes,
      onChange: handleCouponsCodesChange,
      ...
      htmlFor: "block-woo-coupon-codes-operator",
      className: "woo-coupon-codes-inspector__label"
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('The operator applied to evaluate the coupons', 'woocommerce-coupon-shortcodes'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["RadioControl"], {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Operation type', 'woocommerce-coupon-shortcodes'),
      help: selectedOperator === 'and' ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('All the selected Coupons must be active.', 'woocommerce-coupon-shortcodes') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Any of the selected Coupons must be active.', 'woocommerce-coupon-shortcodes'),
...
/***/ "./src/blocks/coupon-is-active/editor.css":
/*!************************************************!*\
  !*** ./src/blocks/coupon-is-active/editor.css ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_coupon_is_active_block_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/coupon-is-active/block.js */ "./src/blocks/coupon-is-active/block.js");
/* harmony import */ var _blocks_coupon_code_block_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blocks/coupon-code/block.js */ "./src/blocks/coupon-code/block.js");
/**
 * index.js
 *
 * Copyright (c) "kento" Karim Rahimpur www.itthinx.com
