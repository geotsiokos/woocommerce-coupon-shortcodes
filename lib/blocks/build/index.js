...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["registerBlockType"])('woocommerce-coupon-shortcodes/coupon-is-active', {
  ...
  edit: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["withSelect"])(function (select) {
    ...
    var coupon_codes_select = props.attributes.coupon_codes_select,
        coupon_codes_operator_select = props.attributes.coupon_codes_operator_select,
        codes = props.codes,
        codes_operator = props.codes_operator,
        className = props.className,
        setAttributes = props.setAttributes,
        isSelected = props.isSelected;
    var coupon_codes_operator_values = [{
      value: 'and',
      label: 'AND'
    }, {
      value: 'or',
    ...
    var handleCouponsCodesOperatorChange = function handleCouponsCodesOperatorChange(coupon_codes_operator_select) {
      return setAttributes({
        coupon_codes_operator_select: JSON.stringify(coupon_codes_operator_select)
      });
    };
    ...
    var selectedCouponCodesOperator = [];

    if (null !== coupon_codes_operator_select) {
      selectedCouponCodesOperator = coupon_codes_operator_values[0];
    }
    ...
    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_10__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["PanelBody"], {
      ...
      help: codes_operator === 'and' ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('All the selected Coupons must be active.', 'woocommerce-coupon-shortcodes') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Any of the selected Coupons must be active.', 'woocommerce-coupon-shortcodes'),
      options: coupon_codes_operator_values,
      onChange: function onChange(value) {
        return setAttributes({
          coupon_codes_operator_values: value
        });
      }
